...
/* @var $model app\models\CartassetsSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="cartassets-search">
    ...
    <?php // echo $form->field($model, 'serviceyear') ?>
    ...
    <?php // echo $form->field($model, 'grnumber') ?>

    <?php // echo $form->field($model, 'donor_funder') ?>

    <?php // echo $form->field($model, 'loa') ?>

    <?php // echo $form->field($model, 'depreciation') ?>

    <?php // echo $form->field($model, 'accumulated_dep') ?>

    <?php // echo $form->field($model, 'bva') ?>

    <?php // echo $form->field($model, 'plate_number') ?>

    <?php // echo $form->field($model, 'fcn') ?>

    <?php // echo $form->field($model, 'fen') ?>

    <?php // echo $form->field($model, 'fx_type') ?>

    <?php // echo $form->field($model, 'fxa') ?>
    ...
    <?php // echo $form->field($model, 'returnables') ?>

    <?php // echo $form->field($model, 'personnelid') ?>

    <?php // echo $form->field($model, 'dt') ?>

    <?php // echo $form->field($model, 'doreturnable') ?>

    <?php // echo $form->field($model, 'monthlyreport') ?>

    <?php // echo $form->field($model, 'yearlyreport') ?>
