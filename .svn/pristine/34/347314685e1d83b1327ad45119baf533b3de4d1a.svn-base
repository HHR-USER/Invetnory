...
/**
 * ConsumablessbsSearch represents the model behind the search form of `app\models\Consumablessbs`.
 */
class ConsumablessbsSearch extends Consumablessbs
{
    /**
     * {@inheritdoc}
     */
