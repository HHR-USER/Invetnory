...
/**
 * ConsumablesclinicalSearch represents the model behind the search form of `app\models\Consumablesclinical`.
 */
class ConsumablesclinicalSearch extends Consumablesclinical
{
    /**
     * {@inheritdoc}
     */
...
public function search($params)
    {
        $query = Consumablesclinical::find();
...
public function search2($params,$id)
    {
        $query = Consumablesclinical::find()->where(['id'=>$id]);
