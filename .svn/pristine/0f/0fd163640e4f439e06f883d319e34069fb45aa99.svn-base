...
/* @var $model app\models\AssetssbsSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="assetssbs-search">
    ...
    <?php // echo $form->field($model, 'deollarmoney') ?>

    <?php // echo $form->field($model, 'birrmany') ?>

    <?php // echo $form->field($model, 'checks') ?>

    <?php // echo $form->field($model, 'checkforserial') ?>
