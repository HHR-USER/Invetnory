...
'panel' => [
        'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon-circle-arrow-right"></i>Asset equipment from pathology storeHouse</h3>',
    ...
    'headerRowOptions' => ['class' => 'kartik-sheet-style','style'=>'background-color:#ccecdd'],
