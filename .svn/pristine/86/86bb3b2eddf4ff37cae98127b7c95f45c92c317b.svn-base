...
?>
<div class="assetsclunical-index">
 <?php Pjax::begin(); ?>
<?php echo GridView::widget([
    ...
    'striped' => true,
    'hover' => true,
    'panel' => ['type' => 'info', 'heading' => 'Assets currently availabel in clinical store'],
    ...
    'columns' => [
        ...
        [
            ...
            'filter' => ArrayHelper::map(app\models\Assetsclinical::find()->orderBy('NOA')->asArray()->all(), 'id', 'NOA'), 
            'filterWidgetOptions' => [
