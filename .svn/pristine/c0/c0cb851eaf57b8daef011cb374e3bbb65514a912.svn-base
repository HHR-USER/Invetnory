...
/* @var $model app\models\ConsumablesMicro */

$this->title ='';
//$this->params['breadcrumbs'][] = ['label' => 'Consumables Micros', 'url' => ['index']];
//$this->params['breadcrumbs'][] = $this->title;
\yii\web\YiiAsset::register($this);
?>
<div class="consumables-micro-view">
...
<span class="glyphicon glyphicon-print" aria-hidden="true"></span>
    ...
    <h5><CENTER><b>This is Consumable stock</b></CENTER>
    <?= DetailView::widget([
        'model' => $model,
        'attributes' => [
            'id',
