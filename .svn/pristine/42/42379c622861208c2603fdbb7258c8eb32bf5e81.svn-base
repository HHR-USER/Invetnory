...
/* @var $model app\models\Assetssbs */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="assetssbs-form">
    ...
    <?= $form->field($model, 'RD')->textInput(['maxlength' => true]) ?>
    ...
    <?= $form->field($model, 'ASSETBARCODE')->textInput(['maxlength' => true]) ?>
    ...
    <?= $form->field($model, 'deollarmoney')->textInput() ?>

    <?= $form->field($model, 'birrmany')->textInput() ?>

    <?= $form->field($model, 'checks')->textInput() ?>

    <?= $form->field($model, 'checkforserial')->textInput() ?>
