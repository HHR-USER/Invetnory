...
<div class="withdrow-form">
    ...
    <?= $form->field($model, 'packsize')->textInput(['maxlength' => true]) ?>
    ...
    <?= $form->field($model, 'expairedate')->textInput() ?>
    ...
    <?= $form->field($model, 'fk_consumable')->textInput() ?>

    <?= $form->field($model, 'fk_forcata')->textInput() ?>

    <?= $form->field($model, 'fk_borrows')->textInput() ?>
    ...
    <?= $form->field($model, 'fk')->textInput() ?>

    <?= $form->field($model, 'fkc')->textInput() ?>

    <?= $form->field($model, 'fkp')->textInput() ?>

    <?= $form->field($model, 'fkm')->textInput() ?>

    <?= $form->field($model, 'For_key')->textInput() ?>

    <?= $form->field($model, 'For_keyc')->textInput() ?>

    <?= $form->field($model, 'For_keyp')->textInput() ?>

    <?= $form->field($model, 'For_keynormal')->textInput() ?>
