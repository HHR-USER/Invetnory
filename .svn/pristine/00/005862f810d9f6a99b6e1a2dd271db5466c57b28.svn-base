...
<?php echo GridView::widget([
    ...
    'striped' => true,
    'hover' => true,
    'panel' => ['type' => 'info', 'heading' => 'Assets currently availabel in SBS store'],
    ...
    'columns' => [
        ...
        [
            ...
            'filter' => ArrayHelper::map(app\models\Assetssbs::find()->orderBy('NOA')->asArray()->all(), 'id', 'NOA'), 
            'filterWidgetOptions' => [
