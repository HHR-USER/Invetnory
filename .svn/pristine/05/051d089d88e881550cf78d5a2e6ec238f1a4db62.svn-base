...
<?php Pjax::begin(); ?>
    ...
    'hover'=>true,
    'panel'=>[//'type'=>'info',
    'heading'=>'Consumables currently available in Pathology store'],
    ...
    ['header'=>'Seq','class'=>'yii\grid\SerialColumn'],
        [
            ...
            'filter' => ArrayHelper::map(app\models\Consumables::find()->where(['store'=>'Pathology'])->orderBy('noi')->asArray()->all(), 'noi', 'noi'), 
            'filterWidgetOptions' => [
