...
/**
 * This is the model class for table "assetssbs".
 *
 * @property int $id
 ...
 */
class Assetssbs extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['quantity', 'shelflife', 'ASSETID', 'PARENTASSET_ID', 'ASSETGROUP_ID', 'LOCATION_ID', 'OWNER_PERSONNELGROUP_ID', 'OWNER_PERSONNEL_ID', 'SERVICEAGREEMENT_ID', 'CUSTODIAN_PERSONNEL_ID', 'STATUS_ID', 'mobile', 'checks', 'checkforserial'], 'integer'],
            ...
            [['catagoryname', 'unit', 'lotnumber', 'serviceyear', 'shelflifedeicide', 'shelfname', 'shelfno', 'birrformat', 'purchasefrom', 'department', 'DOM', 'DOC', 'RD', 'TD', 'Status', 'Place', 'RC', 'RNl', 'RM', 'VENDOR_ID', 'ASSETBARCODE', 'SERIALNUMBER', 'DEPARTMENT_ID', 'CONDITION_ID', 'SCRAPVALUE', 'CURRENTVALUE', 'PURCHASEPRICE', 'ACCOUNTCODE', 'PURCHASEORDERNUMBER', 'ISCHECKEDOUT', 'ASSETNAME', 'AUTOBARCODE', 'ASSETTYPE', 'LOCATION', 'CONDITIONs', 'CUSTODIAN', 'INCLUDEINAUDIT', 'DEPRECIATIONMETHOD', 'RECOVERYPERIOD', 'fname', 'lname', 'office', 'personnelid', 'username', 'dep', 'returnables', 'yearlyreport'], 'string', 'max' => 45],
            [['serial', 'MODEL', 'BRAND', 'MANUFACTURER'], 'string', 'max' => 1000],
            [['monthlyreport'], 'string', 'max' => 11],
        ];
    }
