...
/**
 * AssetspathologySearch represents the model behind the search form of `app\models\Assetspathology`.
 */
class AssetspathologySearch extends Assetspathology
{
    /**
     * {@inheritdoc}
     */
...
public function search2($params,$id)
    {
        $query = Assetspathology::find()->where(['id'=>$id]);
