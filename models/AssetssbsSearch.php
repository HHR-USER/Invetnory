...
/**
 * AssetssbsSearch represents the model behind the search form of `app\models\Assetssbs`.
 */
class AssetssbsSearch extends Assetssbs
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'quantity', 'shelflife', 'ASSETID', 'PARENTASSET_ID', 'ASSETGROUP_ID', 'LOCATION_ID', 'OWNER_PERSONNELGROUP_ID', 'OWNER_PERSONNEL_ID', 'SERVICEAGREEMENT_ID', 'CUSTODIAN_PERSONNEL_ID', 'STATUS_ID', 'mobile', 'checks', 'checkforserial'], 'integer'],
            [['catagoryname', 'unit', 'lotnumber', 'serial', 'MODEL', 'serviceyear', 'shelflifedeicide', 'shelfname', 'shelfno', 'birrformat', 'purchasefrom', 'department', 'NOA', 'DOM', 'DOC', 'RD', 'TD', 'Status', 'Place', 'RC', 'Picture', 'RNl', 'RM', 'VENDOR_ID', 'ASSETBARCODE', 'SERIALNUMBER', 'DEPARTMENT_ID', 'CONDITION_ID', 'SCRAPVALUE', 'CURRENTVALUE', 'PURCHASEPRICE', 'ACCOUNTCODE', 'PURCHASEORDERNUMBER', 'ISCHECKEDOUT', 'ASSETNAME', 'BRAND', 'MANUFACTURER', 'AUTOBARCODE', 'ASSETTYPE', 'LOCATION', 'CONDITIONs', 'CUSTODIAN', 'INCLUDEINAUDIT', 'DEPRECIATIONMETHOD', 'RECOVERYPERIOD', 'DATEINSERVICE', 'DATEAUDITED', 'DUEDATE', 'DATEPURCHASED', 'CHECKOUTDATE', 'DATECREATED', 'DATEUPDATED', 'LASTAUDITDATE', 'DATEWARRANTYEXPIRES', 'NEXTSERVICEDUEDATE', 'NOTES', 'fname', 'lname', 'office', 'personnelid', 'username', 'dep', 'returnables', 'doreturnable'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'deollarmoney' => $this->deollarmoney,
            'birrmany' => $this->birrmany,
            'checks' => $this->checks,
            'checkforserial' => $this->checkforserial,
        ]);
