...
/**
 * This is the model class for table "assetsmicro".
 *
 * @property int $id
 ...
 */
class Assetsmicro extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['catagoryname', 'MODEL', 'ASSETNAME', 'BRAND', 'MANUFACTURER'], 'string', 'max' => 1000],
            [['unit', 'lotnumber', 'serial', 'serviceyear', 'shelflifedeicide', 'shelflife', 'shelfname', 'shelfno', 'birrformat', 'purchasefrom', 'DOM', 'DOC', 'TD', 'Status', 'Place', 'RC', 'RNl', 'RM', 'VENDOR_ID', 'ASSETBARCODE', 'SERIALNUMBER', 'DEPARTMENT_ID', 'CONDITION_ID', 'SCRAPVALUE', 'CURRENTVALUE', 'PURCHASEPRICE', 'ACCOUNTCODE', 'PURCHASEORDERNUMBER', 'ISCHECKEDOUT', 'AUTOBARCODE', 'ASSETTYPE', 'LOCATION', 'CONDITIONs', 'CUSTODIAN', 'INCLUDEINAUDIT', 'DEPRECIATIONMETHOD', 'RECOVERYPERIOD', 'fname', 'lname', 'office', 'personnelid', 'username', 'dep', 'returnables', 'monthlyreport', 'yearlyreport'], 'string', 'max' => 45],
        ];
    }
...
public function attributeLabels()
    {
        return [
            ...
            'doreturnable' => 'Date of returnable',
            'checks' => 'Checks',
