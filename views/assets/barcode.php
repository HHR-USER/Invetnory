    ...
    <div id="printout">
        <?php 
         ...
         foreach ($model as $value) {?>
            ...
            'value'=> $value->assetbarcode, /* value for EAN 13 be careful to set right values for each barcode type */
            'type'=>'code128',/*supported types  ean8, ean13, upc, std25, int25, code11, code39, code93, code128, codabar, msi, datamatrix*/
              
            );
   if($value->assetbarcode!=NULL){
echo BarcodeGenerator::widget($optionsArray).$value->NOA;
    }
else{
