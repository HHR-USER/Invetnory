...
<?php Pjax::begin(); ?>
    ...
    'hover' => true,
    'panel' =>[//'type'=>'info',
     'heading'=>'Consumables currently available in CHAMPS store'],
    ...
    'columns'=>[
        ...
        [
            ...
            'filter' => ArrayHelper::map(app\models\Consumables::find()->where(['store'=>'Admin'])->orderBy('noi')->asArray()->all(), 'noi', 'noi'), 
            'filterWidgetOptions' => [
