...
<?php Pjax::begin(); ?>
    ...
    'striped' => true,
    'hover' => true,
    'panel' => ['type' => 'info', 'heading' => 'Consumables currently availabel in Microlab store'],
    ...
    'columns' => [
        ...
        [
            ...
            'filter' => ArrayHelper::map(app\models\Consumablesmicro::find()->orderBy('noi')->asArray()->all(), 'id', 'noi'), 
            'filterWidgetOptions' => [
