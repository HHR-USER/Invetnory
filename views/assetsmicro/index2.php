...
<?php echo GridView::widget([
    ...
    'striped' => true,
    'hover' => true,
    'panel' => ['type' => 'info', 'heading' => 'Assets currently availabel in Microlab store'],
    ...
    'columns' => [
        ...
        [
            ...
            'filter' => ArrayHelper::map(app\models\Assetsmicro::find()->orderBy('NOA')->asArray()->all(), 'id', 'NOA'), 
            'filterWidgetOptions' => [
