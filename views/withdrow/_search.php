...
/* @var $model app\models\WithdrowSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="withdrow-search">
    ...
    <?php // echo $form->field($model, 'fkc') ?>

    <?php // echo $form->field($model, 'fkp') ?>

    <?php // echo $form->field($model, 'fkm') ?>

    <?php // echo $form->field($model, 'For_key') ?>

    <?php // echo $form->field($model, 'For_keyc') ?>

    <?php // echo $form->field($model, 'For_keyp') ?>

    <?php // echo $form->field($model, 'For_keynormal') ?>
