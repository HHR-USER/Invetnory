...
'panel' => [
        ...
        $mo=Consumablesclinical::find()->where(['birrformat'=>'birr'])->all(),
        $moo=Consumablesclinical::find()->where(['birrformat'=>'$'])->all(),
        $query=(new \yii\db\Query())->from('consumablesclinical')->where(['birrformat'=>'birr']),
        $sum=$query->sum('cost'),
        $query1=(new \yii\db\Query())->from('consumablesclinical')->where(['birrformat'=>'$']),
...
<script type="text/javascript">          
  ...
  function consumable()
       {
     var catagory=$("#consumablesclinical-catagory").val();
     var noi=$("#consumablesclinical-noi").val();
     var packsize=$("#consumablesclinical-packsize").val();
     var unit=$("#consumablesclinical-unit").val();
     var lot=$("#consumablesclinical-lot").val();
     var quantity=$("#consumablesclinical-quantity").val();
     var dp=$("#consumablesclinical-dp").val();
     var expairedate=$("#consumablesclinical-expairedate").val();
     var shelflife=$("#consumablesclinical-shelflife").val();
     var location=$("#consumablesclinical-location").val();
     var shelfname=$("#consumablesclinical-shelfname").val();
     var shelfno=$("#consumablesclinical-shelfno").val();
     var dr=$("#consumablesclinical-dr").val();
     var am=$("#consumablesclinical-am").val();
     var department=$("#consumablesclinical-department").val();
     var birrformat=$("#consumablesclinical-birrformat").val();
     var cost=$("#consumablesclinical-cost").val();
     var purchasefrom=$("#consumablesclinical-purchasefrom").val();
     var unit=$("#consumablesclinical-unit").val();
     var remark=$("#consumablesclinical-remark").val();
     var id=$("#consumablesid").val();
    var href = "<?=Yii::$app->request->baseUrl;?>/index.php/consumablesclinical/create1/"+"?catagory="+catagory+"&noi="+noi+"&packsize="+packsize+"&unit="+unit+"&lot="+lot+"&quantity="+quantity+"&dp="+dp+"&expairedate="+expairedate+"&shelflife="+shelflife+"&location="+location+"&shelfname="+shelfname+"&shelfno="+shelfno+"&dr="+dr+"&am="+am+"&department="+department+"&birrformat="+birrformat+"&cost="+cost+"&purchasefrom="+purchasefrom+"&unit="+unit+"&remark="+remark;
